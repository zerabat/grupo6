...
public class RealizacionEspectaculoUsuarioFull {
	...
	public RealizacionEspectaculoUsuarioFull(){
		
	}
	public RealizacionEspectaculoUsuarioFull(RealizacionEspectaculo x) {
		this.id = x.getId();
