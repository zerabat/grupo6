...
public class EspectaculoConTealizacionesDTO {
	...
	private List<RealizacionEspectaculoDTO> realizacionEspectaculo;
	
	public EspectaculoConTealizacionesDTO(Espectaculo e) {
		this.id = e.getId();
	...
	public EspectaculoConTealizacionesDTO() {
	}
	...
	public List<RealizacionEspectaculoDTO> getRealizacionEspectaculo() {
		return realizacionEspectaculo;
	}

	public void setRealizacionEspectaculo(List<RealizacionEspectaculoDTO> realizacionEspectaculo) {
