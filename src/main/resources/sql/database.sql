...
CREATE TABLE `espectaculo_tipoespectaculo` (
  ...
  CONSTRAINT `fk_EscpTEsp_TipoEspectaculo` FOREIGN KEY (`id_tipoEspectaculo`) REFERENCES `tipo_espectaculo` (`id_tipo_espectaculo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
